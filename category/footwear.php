...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="Medicine.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Saree</a>
				</th>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($conn, "SELECT * FROM products WHERE available >='1' AND item ='footWear'  ORDER BY id DESC LIMIT 10") or die(mysqli_error($conn));
