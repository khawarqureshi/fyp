	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Allergy.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Allergy</a></th>
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/Allergy/'.$picture.'" class="home-prodlist-imgi">
										</a>
