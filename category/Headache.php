...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="Headache.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Headache</a>
				</th>
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/Headache/'.$picture.'" class="home-prodlist-imgi">
										</a>
